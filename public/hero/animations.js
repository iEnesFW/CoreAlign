/* AUTO-GENERATED from animations.jsx (Babel 7.26.4 presets react,typescript). Edit the .jsx then re-run the transpile. */
function _extends() {
  return (
...
function Stage({
  ...
  // Sizing is handled purely by CSS now (svg viewBox + preserveAspectRatio +
  // width/height:100% inside the flex-centered container), so there is no JS
  // measurement to race with the DC x-import mount lifecycle.
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(PlaybackBar, {
      time: displayTime,
      actualTime: time,
      duration: duration,
      playing: playing,
