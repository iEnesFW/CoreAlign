    ...
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
      ...
      <svg width="1920" height="1080" style={{ position: 'absolute', inset: 0 }}>
        {STARS.map((s, i) => {
          ...
          return <circle key={i} cx={s.x} cy={s.y} r={s.r} fill="#cdd8ff" opacity={tw * 0.8} />;
        })}
      </svg>
    ...
    <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }}>
      <div
        style={{
          ...
          inset: 0,
          background:
            'radial-gradient(125% 105% at 50% 44%, transparent 52%, rgba(0,0,0,0.5) 100%)',
        }}
      />
      <div
        style={{
  ...
  return (
    <svg width={W} height={132} viewBox={`0 0 ${W} 132`}>
      {rows.map((r, i) => {
        ...
        return (
          <g key={i}>
            <rect x="0" y={8 + i * 25} width={W} height={12} rx="6" fill="rgba(255,255,255,0.04)" />
            <rect
              x={x0}
              y={8 + i * 25}
              width={full * p}
  ...
  return (
    <defs>
      <linearGradient id="cadGlass" x1="0" y1="0" x2="0.25" y2="1">
        <stop offset="0" stopColor="#cfe6ff" stopOpacity="0.22" />
        <stop offset="0.5" stopColor="#8fb6ee" stopOpacity="0.08" />
        <stop offset="1" stopColor="#a6c8ff" stopOpacity="0.16" />
      </linearGradient>
      <radialGradient id="cadFloor" cx="0.45" cy="0.4" r="0.7">
        <stop offset="0" stopColor={hexA(C.indigo, 0.2)} />
        <stop offset="1" stopColor={hexA(C.indigo, 0)} />
      </radialGradient>
      <linearGradient id="cadAluV" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0" stopColor="#3c4570" />
        <stop offset="0.45" stopColor="#aab4dd" />
        <stop offset="0.6" stopColor="#c8d2f2" />
        <stop offset="1" stopColor="#363e63" />
      </linearGradient>
      <linearGradient id="cadAluH" x1="0" y1="0" x2="1" y2="0.3">
        <stop offset="0" stopColor="#9aa6d4" />
        <stop offset="0.5" stopColor="#c3cdf0" />
        <stop offset="1" stopColor="#4a527e" />
      </linearGradient>
    </defs>
  );
}
              ...
              {w.pts.slice(0, -1).map((p, i) => {
                ...
                return (
                  <g key={i}>
                    ...
                    <polygon points={poly} fill="#04060e" opacity={(1 - w.sh) * 0.42} />
                    <polygon
                      points={poly}
                      fill="none"
