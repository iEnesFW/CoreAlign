...
export const PersonaModeSwitch = () => {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-[5px] border border-slate-200 px-2 py-1 text-[11px] font-medium text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 transition-colors focus:outline-none focus:ring-1 focus:ring-indigo-500"
    >
      <Icon size={14} />
