...
export const ProductPicker = forwardRef<HTMLInputElement, Props>(
  ({ products, value, disabled, invalid, onSelect }, ref) => {
    ...
    // Sync the displayed text when the selected product changes externally
    // (e.g. the parent resets the form on edit). Adjusting during render avoids
    // the cascading re-render that an effect would cause.
      ...
      <div className="relative">
        ...
        {open && filtered.length > 0 && (
          <ul
            ...
            role="listbox"
            onMouseDown={(e) => {
              // Prevent input blur from firing before click selection.
              e.preventDefault();
