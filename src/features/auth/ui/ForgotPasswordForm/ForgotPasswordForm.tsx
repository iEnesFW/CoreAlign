            ...
            <div className={styles.form}>
                <div className={styles.header}>
                    ...
                    <div className={styles.successMessage}>
                        ...
                        <Link to="/login" className={styles.link}>{t('auth.forgotPassword.success.backToLogin')}</Link>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.actions}>
                <Button type="submit" isLoading={forgotPasswordMutation.isPending} className={styles.submitButton}>
                    {t('auth.forgotPassword.submitButton')}
                </Button>
            </div>

            <div className={styles.footer}>
                <Link to="/login" className={styles.link}>{t('auth.forgotPassword.backToLogin')}</Link>
            </div>
        </form>
    );
};
