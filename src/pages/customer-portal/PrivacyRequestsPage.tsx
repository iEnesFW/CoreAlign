...
export const PrivacyRequestsPage = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 p-4 sm:p-6">
      ...
      {lastSubmittedId && (
        <div className="rounded-lg border border-success-200 bg-success-50 p-4 text-sm text-success-900 dark:border-success-700/50 dark:bg-success-900/20 dark:text-success-200">
