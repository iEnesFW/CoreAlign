...
public static class InvoiceMapper
{
    public static InvoiceDto ToDto(Invoice invoice)
    {
        ...
        return new InvoiceDto
        {
            ...
            EInvoiceGibStatusCode = invoice.EInvoiceGibStatusCode,
            EInvoiceRejectReason = invoice.EInvoiceRejectReason,
            EInvoiceSentAtUtc = invoice.EInvoiceSentAtUtc,
            VatExemptionCodeId = invoice.VatExemptionCodeId,
            VatExemptionCode = invoice.VatExemptionCode,
